...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile Bottom Bar */}
      <div className="md:hidden fixed bottom-0 left-0 w-screen right-0 bg-gradient-to-r from-[#3B0A4F] via-[#4C1360] to-[#3B0A4F] backdrop-blur-lg shadow-2xl flex justify-around items-center h-16 z-50 rounded-t-2xl border-t border-[#E5C97B]/30 safe-area-inset-bottom">
